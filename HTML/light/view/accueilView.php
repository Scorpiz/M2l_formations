...
<section class="content-wrap">
    ...
    <!-- Images With Text -->
    <h2 class="container h1">Specials <a href="#!" class="btn pull-right">Voir plus</a></h2>
            ...
            <div class="row vertical-gutter">
                <div class="col-md-4">
                    <a href="blog-post-2.html" class="angled-img">
                        ...
                        <div class="youplay-hexagon-rating youplay-hexagon-rating-small" data-max="10" data-back-color="rgba(60,7,50,0.1)" data-front-color="#3C0732" data-size="50" title="9 out of 10"><span>9</span>
                        </div>
                    </a>
                </div>
                <div class="col-md-8">
                    ...
                    <div class="tags">
                        <i class="fa fa-tags"></i>  <a href="#">Botanicula</a>, <a href="#">coming soon</a>, <a href="#">first review</a>, <a href="#">sale date</a>
                    </div>
                    <div class="description">
            ...
            <div class="row vertical-gutter">
                <div class="col-md-4">
                    <a href="blog-post-3.html" class="angled-img">
                        ...
                        <div class="youplay-hexagon-rating youplay-hexagon-rating-small" data-max="10" data-back-color="rgba(60,7,50,0.1)" data-front-color="#3C0732" data-size="50" title="9.3 out of 10"><span>9.3</span>
                        </div>
                    </a>
                </div>
                <div class="col-md-8">
